...
printf "y\ny\ny\n" | ./run_db_pa.sh lubm140M ressources/LUBM-ex-20.dlp /local/data/DLP/Base_1000U/ N N O
# dbname=$1
...
# # echo dlp.filesDirectory = /local/pa/disable-reasoning/npd100.nt  >> load.properties
...
# echo database.password = cbel  >> load.properties
# ./load_data.sh 
...
# echo database.password = Brexe31@@  >> load.properties
# ./load_data.sh 
