...
# do
#     ./run_queries_pa.sh lubm75M ressources/LUBM-ex-20.owl ressources/LUBM-ex-20.dlp $queriesGroup N O N
# done 
DB=lubm130M
...
# echo database.password = Brexe31@@  >> summary.properties
...
# for queriesGroup in cc
# do
#     ./run_queries_pa.sh $DB ressources/LUBM-ex-20.owl ressources/LUBM-ex-20.dlp $queriesGroup O N N
# done 
...
echo database.password = cbel  >> summary.properties
...
# for queriesGroup in cc
# do
#     ./run_queries_pa.sh $DB ressources/LUBM-ex-20.owl ressources/LUBM-ex-20.dlp $queriesGroup N O N
# done 
