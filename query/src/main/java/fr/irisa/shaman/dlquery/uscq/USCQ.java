...
public class USCQ {
	...
	public String reformulate(String oquery){
		...
		//String jar = root+"/query/lib/compact.jar";
		// Run a java app in a separate system process
		//"java -jar query/lib/compact.jar -r ressources/LUBM-ex-20.dlp -q ressources/Compact/q1001.txt  -o ressources/Compact/ -f q1001"
		/*String cmd = String.format("java -jar %s -r %s -q %s/%s.txt -o %s -f %s ",jar, ontologypath, querypath, queryName, querypath, queryName);
		...
		try {
		    ...
		    proc.waitFor();
			uscqQuery = usqcConverter.getUSCQ(queryName);
