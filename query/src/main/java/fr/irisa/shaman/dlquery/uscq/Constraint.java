...
public class Constraint {
	...
	public Object getSecondVar() {
		...
		//secondVarCte = secondVarCte.replace("\"", "");
		/*if(secondVarCte.contains("#")) {
			secondVarCte = secondVarCte.split("#")[1];
		}else {
			secondVarCte = secondVarCte.substring(secondVarCte.lastIndexOf("/")+1, secondVarCte.length());
		}*/
		return secondVarCte;
	}
...
//		Constraint test = new Constraint("disj_0_5.c1 = \'hii\'");
//		
