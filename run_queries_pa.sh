...
# echo database.ontology = ressources/LUBM-ex-20.owl  >> query.properties
# echo compact.ontology  = ressources/LUBM-ex-20.dlp  >> query.properties
# echo database.ontology = ressources/npd-v2-ql.owl  >> query.properties
# echo compact.ontology  = ressources/npd-v2-ql.dlp  >> query.properties

inputdb=$dbname
# vacuumdb -f --analyze $dbname
# vacuumdb --analyze $dbname
# echo query.store = None  >> query.properties
...
for nb in `seq 1 3` ; do
	...
	if [[ "$1" == "O" ]] ; then
		case $nb in 
			...
			echo database.password = cbel  >> query.properties
			...
			echo database.password = Brexe31@@  >> query.properties
		...
		# echo database.queries  = ressources/npd-$queriesGroup.queries    >> query.properties
